...
{  
   ...
   "pings": [],
   "creator": 6,
   "fullname": "Mario Ricci",
   "profile_picture_url": "img/users/user-icon-02.png",
...
{  
   ...
   "profile_picture_url": "img/users/user-icon-default.png",
...
{  
   ...
   "creator": 1,
   "fullname": "You",
   "profile_picture_url": "img/users/user-icon-01.png",
   "created_by_admin": false,
...
{  
   ...
   "profile_picture_url": "img/users/user-icon-04.png",
   "created_by_admin": false,
   "created_by_current_user": false,
   "upvote_count": 0,
   "user_has_upvoted": false
...
{  
   ...
   "creator": 3,
   "fullname": "Hank Smith",
   "profile_picture_url": "img/users/user-icon-03.png",
   "created_by_admin": false,
   "created_by_current_user": false,
   "upvote_count": 0,
   "user_has_upvoted": false
